...
date: "2024-05-15"
excerpt: "A curated list of books that I love and recommend"
---

This is a list of books that I love and have found valuable. This is an always-updating list.

My [Goodreads profile](https://goodreads.com/user/show/143667799-cristian) is where I track all my reading.
...
Now, **Apple Notes** is my centralized second brain. Everything lives there—quick thoughts, reference materials, study notes, project documentation, and anything else I need to capture or remember. Having everything in one place means I can search across all my knowledge instantly, without context switching between apps. It's fast, always accessible across all my devices, and surprisingly powerful once you learn to organize it well.
